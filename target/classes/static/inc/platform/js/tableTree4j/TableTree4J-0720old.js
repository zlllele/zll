	...
	TableTree4J.prototype.codeNodeTR=function(node){//changeClassName
		...
		if(this.config.booleanHighLightRow==true&&node.booleanRoot==false){
			if(node.classStyle!=null&&node.classStyle!=""){
				if(node.nodeText=="�鿴ĳ���ż��¼�"||node.nodeText=="�鿴������"||node.nodeText=="�鿴����")
				{
					changeClassMark=" ";
...
function checkedTreeNode(nodeid,tree){
	 ...
	 //trElement.onmouseout="";
		...
		if(tempNode.nodeText=="�鿴ĳ���ż��¼�"||tempNode.nodeText=="�鿴������"||tempNode.nodeText=="�鿴����"){
...
//����ӽڵ��ѡ��״̬��4���ø��ڵ��ѡ��״̬��ʵ���߼����ܣ����ӽڵ�ѡ��ʱ�����ϼ��Ľڵ�Ҳͬ��ѡ�С�
...
//����ӽڵ��ѡ��״̬��4���ø��ڵ��ѡ��״̬2���߼����壺����ӽڵ㶼ѡ�У���ֻ��ѡ�и��ڵ��ӽڵ�ѡ��״̬Ϊδѡ
function checkedParentNode2(node,ischeck,tree){
	if(node.pNode.id!=tree.rootNode.id&&node.pNode.nodeText!="�鿴ĳ���ż��¼�"){
		var pNode = node.pNode;
 	if(ischeck){
	...
	if(node.nodeText=="�鿴ĳ���ż��¼�"&&!document.getElementById("chk"+node.id).checked){
	//���鿴ĳ���ż��¼�δѡ�������¼��ڵ�Ҳ����ΪΪѡ��
