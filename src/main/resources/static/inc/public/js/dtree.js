function dTree(objName) {
	...
	this.icon = {
		root		: '../images/img1/base.gif',
		folder		: '../images/img1/folder.gif',
		folderOpen	: '../images/img1/folderopen.gif',
		node		: '../images/img1/page.gif',
		empty		: '../images/img1/empty.gif',
		line		: '../images/img1/line.gif',
		join		: '../images/img1/join.gif',
		joinBottom	: '../images/img1/joinbottom.gif',
		plus		: '../images/img1/plus.gif',
		plusBottom	: '../images/img1/plusbottom.gif',
		minus		: '../images/img1/minus.gif',
		minusBottom	: '../images/img1/minusbottom.gif',
		nlPlus		: '../images/img1/nolines_plus.gif',
		nlMinus		: '../images/img1/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
