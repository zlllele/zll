...
function numFilter(obj,nullFlag){
   ...
   <tr style="" height="20px" style="font-size:12px;" id="serachTR">
    <input type="hidden" name="ZZJG_DM">
   	<td align="left" colspan="3">姓名：<input type="text" id="CZRY_MC" name="CZRY_MC" value="<htjs:get data_key="CZRY_MC"/>"  maxlength="8" style="width:120px"/>&nbsp;&nbsp;
   	手机号码：<input id="DX_SJHM" name="DX_SJHM" type="text"  value="<htjs:get data_key="DX_SJHM"/>"  maxlength="14" style="width:120px" onkeydown="javascript:return checkPhone(event,this,12)" onBlur="javascript:numFilter(this)"/>
   	<input type="submit" value="查询" class="btn_img_bg"/> 
   	</td>
   </tr>
</from>
   <tr height="20px" style="font-size:12px;">
   	<td align="center" id="f1">待选用户</td>
   	<td></td>
   	<td align="center" id="f2">已选用户</td>
   </tr>
   <tr >
   <td align="center" >
       <select multiple="multiple" id="userA" name="user" style="width:180px;height:98%;" class="mm-mselect" ondblclick="addOption()">
       		<htjs:iterator sid="selectDM_CZRY_DX_SJHM" param="ZZJG_DM=1" isPage="true">
       			<option value="<htjs:get property="ZZJG_DM"/>_<htjs:get property="CZRY_DM"/>_<htjs:get property="DX_SJHM"/>_<htjs:get property="CZRY_MC"/>_<htjs:get property="CZRY_MC"/>_<htjs:get property="CZRY_DM" convert="table:PT_QX_USER;dm:CZRY_DM;mc:USERNAME"/>"><htjs:get property="CZRY_MC"/>/<htjs:get property="DX_SJHM"/></option>
       		</htjs:iterator>
       </select>
   </td>
   <td align="center">
