	...
	public Object add(@RequestParam Map<String, Object> siteMap, String callback, HttpServletRequest request) {
		...
		try {
			...
			//修改
				...
				String oldTplSolution = String.valueOf(siteMap.get("old_sys_tpl_solution"));
				String newTplSolution = String.valueOf(siteMap.get("sys_tpl_solution"));
				if (!newTplSolution.equals(oldTplSolution)) {
					//模板
